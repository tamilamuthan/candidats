            ...
            <form name="editCompanyForm" id="editCompanyForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=companies&amp;a=edit" method="post" onsubmit="return checkEditForm(document.editCompanyForm);" autocomplete="off">
                        ...
                        <td width="50%" valign="top" height="285">
                            ...
                            <table class="editTable" width="100%" height="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="tdData">
                                        <input type="text" name="faxNumber" id="faxNumber" value="<?php $this->_($this->data['fax_number']); ?>" class="inputbox" style="width: 150px" onkeydown="document.getElementById('changeAddress').style.display='';" />
                                    </td>
                                </tr>
                ...
                <table class="editTable" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" class="inputbox" id="keyTechnologies" name="keyTechnologies" value="<?php $this->_($this->data['key_technologies']); ?>" style="width: 400px" />
                        </td>
                    </tr>

            ...
            <tr>
                ...
                <td class="tdData">
                    <select tabindex="6" id="owner" name="owner" class="inputbox" style="width: 150px;">
                        ...
                        <optgroup label="User">
                        <?php 
                        foreach ($this->usersRS as $rowNumber => $usersData)
                        { 
                            if ($usersData['userID'] == $this->userID)
                            { 
                                echo "<option selected value='0:{$usersData['userID']}'>{$usersData['lastName']} {$usersData['firstName']}</option>";
                            }
                            else
                            { 
                                echo "<option value='0:{$usersData['userID']}'>{$usersData['lastName']} {$usersData['firstName']}</option>";
                            } 
                        } 
                        ?>
                        </optgroup>
                        ...
                        { 
                            echo "<option value='1:{$groupData['id']}'>{$groupData['groupname']}</option>";
                        } 
                        ?>
                        </optgroup>
                    </select>&nbsp;*

...
{//trace($record);
    ...
    {
        $arrField["data"]="<div id='shortDescription' style='overflow: auto; height:170px; border: #AAA 1px solid; padding:5px;'>{$record['description']}</div>";
    }
    $arrField["data"]="";
    return $arrField;
};
$notes=function ($record)
{//trace($record);
    $field="notes";
    $data="";
    $arrField=array();
    ...
    {
        $arrField["data"]="<div id='shortDescription' style='overflow: auto; height:170px; border: #AAA 1px solid; padding:5px;'>{$record['notes']}</div>";
    }
    $arrField["data"]="";
    return $arrField;
};

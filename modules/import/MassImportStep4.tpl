    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td colspan="3" valign="top" style="padding-top: 20px;">
                ...
                <p />
                A document fails to import because it's either corrupt or CandidATS doesn't know how to open it. You
                could try to convert these files to CandidATS-friendly formats like Microsoft Word, Adobe PDF or as

...
<script type="text/javascript">
    ...
    function mergeAndDelete(obj)
    {
        <?php
            ...
            {
                $mergeDelete="&attachmentID={$_GET["attachmentID"]}";
            }
        ?>
        document.addCandidateForm.action="index.php?m=candidates&a=merge<?php echo $mergeDelete; ?>&candidateID="+candidateIsAlreadyInSystemID;
        document.addCandidateForm.submit();
    }

            ...
            <form name="editCandidateForm" id="editCandidateForm" action="<?php echo(CATSUtility::getIndexName()); ?>?m=candidates&amp;a=edit" method="post" onsubmit="return checkEditForm(document.editCandidateForm);" autocomplete="off">
                ...
                <table class="editTable" width="700">
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" class="inputbox" id="middleName" name="middleName" value="<?php $this->_($this->data['middle_name']); ?>" style="width: 150px;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" class="inputbox" id="lastName" name="lastName" value="<?php $this->_($this->data['last_name']); ?>" style="width: 150px;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" class="inputbox" id="phoneHome" name="phoneHome" value="<?php $this->_($this->data['phone_home']); ?>" style="width: 150px;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" class="inputbox" id="phoneCell" name="phoneCell" value="<?php $this->_($this->data['phone_cell']); ?>" style="width: 150px;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" class="inputbox" id="phoneWork" name="phoneWork" value="<?php $this->_($this->data['phone_work']); ?>" style="width: 150px;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" class="inputbox" id="webSite" name="webSite" value="<?php $this->_($this->data['web_site']); ?>" style="width: 150px" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" class="inputbox" id="bestTimeToCall" name="bestTimeToCall" value="<?php $this->_($this->data['best_time_to_call']); ?>" style="width: 150px;" />
                        </td>
                    </tr>
                ...
                <?php if($this->EEOSettingsRS['enabled'] == 1):
                    ...
                    <?php }else{ ?>
                        <table class="editTable" width="700">
                    <?php 
                    if ($this->EEOSettingsRS['genderTracking'] == 1){ ?>
                             <tr>
                                <td class="tdVertical">
                ...
                <table class="editTable" width="700">
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="checkbox" id="canRelocate" name="canRelocate"<?php if ($this->data['can_relocate'] == 1): ?> checked<?php endif; ?> />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" class="inputbox" id="currentEmployer" name="currentEmployer" value="<?php $this->_($this->data['current_employer']); ?>" style="width: 150px;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" name="currentPay" id="currentPay" value="<?php $this->_($this->data['current_pay']); ?>" class="inputbox" style="width: 150px" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" name="desiredPay" id="desiredPay" value="<?php $this->_($this->data['desired_pay']); ?>" class="inputbox" style="width: 150px" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tdData">
                            <input type="text" class="inputbox" id="keySkills" name="keySkills" value="<?php $this->_($this->data['key_skills']); ?>" style="width: 400px;" />
                        </td>
                    </tr>

...
<!-- Icon, dropdown, and clock -->
        ...
        <div id="icon" title="Hastymail 2">
            ...
            <div id="dropdown_outer"><div id="dd_inner"><?php echo $pd->print_folder_dropdown($pd->pd['folders']).'</div>
                 <complex-'.$page_id.'><div id="clock_div">'.$pd->print_clock().'</div>
                 ...
                 </complex-'.$page_id.'>'.do_display_hook('clock') ?>
            </div>
...
<!-- main menu --> 
        ...
        <div id="menu"><?php echo '
            ...
            '<a href="?page=compose&amp;compose_session=new&amp;mailbox='.$pd->pd['url_mailbox'].'" onclick="'.$pd->pd['compose_onclick'].'" class="'.$pd->pd['compose_link_class'].'">'.$pd->user->str[3].'</a>&#160; '.
...
<!-- folder list if enabled -->
            ...
            <table cellpadding="0" cellspacing="0" style="clear: both;" width="100%"><tr><td valign="top" id="folder_cell">
                <div id="folder_cell_inner" <?php if (isset($_SESSION['hide_folder_list']) && $_SESSION['hide_folder_list']) {echo 'style="display: none;" '; }?>>
                <b class="rtop"><b class="r1">&#160;</b><b class="r2">&#160;</b><b class="r3">&#160;</b><b class="r4">&#160;</b></b>
                <div class="folder_border"><b class="ftop"><b class="f1">&#160;</b><b class="f2">&#160;</b>
                <b class="f3">&#160;</b><b class="f4">&#160;</b></b><div class="folder_inner">
                <?php echo do_display_hook('folder_list_top') ?><div id="folder_outer"><div><?php echo $pd->print_folder_list($pd->pd['folders']) ?></div></div>
                <?php echo do_display_hook('folder_list_bottom') ?><div id="hide_link"><a href="<?php echo $sticky_url ?>" onclick="hide_folder_list(); return false;"><?php
                echo $pd->user->str[61] ?></a></div></div><b class="fbottom"><b class="f4">&#160;</b><b class="f3">&#160;</b><b class="f2">&#160;</b><b class="f1">&#160;</b></b>
                </div><b class="rbottom"><b class="r4">&#160;</b><b class="r3">&#160;</b><b class="r2">&#160;</b><b class="r1">&#160;</b></b>
                </div></td><td valign="top" width="99%"><?php echo '</complex-'.$page_id.'>'; } ?>


<!-- user notices/errors  -->

                    <div id="content">
                        <?php echo '<complex-'.$page_id.'>'; ?><b class="rtop"><b class="r1">&#160;</b><b class="r2">&#160;</b><b class="r3">&#160;</b><b class="r4">&#160;</b></b>
                        <?php echo '</complex-'.$page_id.'>'; ?><div id="content_outer"><?php echo '<complex-'.$page_id.'>'; ?>
                        <b class="itop"><b class="i1">&#160;</b><b class="i2">&#160;</b><b class="i3">&#160;</b><b class="i4">&#160;</b></b>
...
<!-- jump to the page specific template -->
                        ...
                        <b class="ibottom"><b class="i4">&#160;</b><b class="i3">&#160;</b><b class="i2">&#160;</b><b class="fi">&#160;</b></b>
                        <?php echo '</complex-'.$page_id.'>'; ?></div><?php echo '<complex-'.$page_id.'>'; ?><b class="rbottom"><b class="r4">&#160;</b><b class="r3">&#160;</b>
                        <b class="r2">&#160;</b><b class="r1">&#160;</b></b><?php echo '</complex-'.$page_id.'>'; ?></div>

<!-- close additional tags if we are showing the folder list -->

            <?php if (isset($pd->pd['settings']['show_folder_list']) && !$pd->new_window && $pd->pd['settings']['show_folder_list']) { echo '<complex-'.$page_id.'>' ?></td></tr></table>
...
<!-- page footer -->
    ...
    <?php echo do_display_hook("footer") ?><complex-<?php echo $page_id ?>>&copy; Hastymail Development Group 2010</complex-<?php echo $page_id ?>>
    </div><?php echo $pd->print_inline_js() ?>
    </body>
</html>

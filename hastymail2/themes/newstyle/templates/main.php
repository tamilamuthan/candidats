...
<!-- main menu --> 
        ...
        <div id="menu"><?php echo '
            <complex-'.$page_id.'>
            <span id="unread_total"><a href="?page=new&amp;mailbox='.urlencode($pd->pd['mailbox']).'">'.sprintf($pd->user->str[34], $_SESSION['total_unread']).'</a></span>&#160;
...
<!-- page footer -->
    ...
    <div id="footer">
        ...
        &copy; Hastymail Development Group 2010
    </div>

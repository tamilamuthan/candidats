...
<!-- main menu --> 
        ...
        <div id="menu"><?php echo '
            <complex-'.$page_id.'>
            <a href="?page=compose&amp;compose_session=new&amp;mailbox='.$pd->pd['url_mailbox'].'" onclick="'.$pd->pd['compose_onclick'].'" class="'.$pd->pd['compose_link_class'].'"><img src="themes/'.$pd->pd['theme'].'/images/compose.png" alt="'.$pd->user->str[3].'" title="'.$pd->user->str[3].'" /></a>&#160;

...
define('SHEDULES_CALL',        100);
define('SHEDULES_EMAIL',       200);
define('SHEDULES_MEETING',     300);
define('SHEDULES_OTHER',       400);
define('SHEDULES_CALL_TALKED', 500);
define('SHEDULES_CALL_LVM',    600);
define('SHEDULES_CALL_MISSED', 700);
 ...
 *  @subpackage Library
 */
class Shedules extends Modules
{

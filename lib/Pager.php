...
class Pager
{
    ...
    public function printNavigation($defaultSortBy = '', $drawAlpha2 = true, $maxPagesSetting = -1)
    {
        ...
        if ($this->_currentPage != 1)
        {
            ...
            echo sprintf(
                '<a class="pagerPrevNext" href="%s?%s&amp;page=%s&amp;sortBy=%s&amp;sortDirection=%s'.$bulk_resume_url.'">&lt;&lt; Previous</a>%s',
                $indexName,
                $this->_baseURL,
                ($this->_currentPage - 1),
                $this->_sortBy,
        ...
        if ($this->_currentPage != $this->_totalPages)
        {
            ...
            echo sprintf(
                '<a class="pagerPrevNext" href="%s?%s&amp;page=%s&amp;sortBy=%s&amp;sortDirection=%s'.$bulk_resume_url.'">Next &gt;&gt;</a>%s',
                $indexName,
                $this->_baseURL,
                ($this->_currentPage + 1),
                $this->_sortBy,

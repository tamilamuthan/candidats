...
define('COMMONERROR_EMAILFAILED',                          13);
...
class CommonErrors
{
        ...
        switch ($code)
        {
            ...
            case COMMONERROR_PERMISSION:
                ...
                $errorMessage = 'You don\'t have access to the action you\'re attempting to perform. If you '
                    ...
                    . 'You can click the <a href="javascript:history.back()">back</a> button on your browser to return '
            ...
            case COMMONERROR_EMAILFAILED:
                $errorTitle = 'Email failed';
                $internalErrorTitle = 'email fail';
                $errorMessage = 'The email send failed with error: "<b>' . htmlentities($customMessage) . '</b>"';
                break;
            ...
            default:
                ...
                $errorMessage = 'An error has occurred and the operation you were attempting to perform cannot be '
                    . 'completed. Please use the <a href="javascript:history.back();">back</a> button on your web browser '
    ...
    private static function isExceptionLoggingEnabled()
    {
        ...
        $tables = array();
        $rs = $db->getAllRow('show tables');
        foreach ($rs as $tbl) $tables[] = $tbl[0];
